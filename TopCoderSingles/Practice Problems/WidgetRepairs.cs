...
{
    public class WidgetRepairs : ProblemBase
    {
        public override string Name => "Widget Repairs";

        public override string Link => "https://arena.topcoder.com/#/u/practiceCode/1262/1270/1346/2/1262";

        public override string CodeAsString => @"            public int days(int[] arrivals, int numPerDay)
            {
...
";
        ...
        protected override IExample[] Examples => new WidgetRepairsExample[]
        {
